...
def _write_pw_worker():
    ...
    lines = [
        ...
        '\n',
        '        # ── Tìm nút Đăng TRONG dialog trước, tránh click nhầm nút ngoài feed ──\n',
        '        posted = False\n',
        '\n',
        '        # Bước 1: Tìm dialog/sheet chứa compose\n',
        '        dialog_sels = [\n',
        '            \'[role="dialog"]\',\n',
        '            \'[role="sheet"]\',\n',
        '            \'div:has-text("Thread mới")\',\n',
        '            \'div:has-text("New thread")\',\n',
        '        ]\n',
        '        dialog = None\n',
        '        for d_sel in dialog_sels:\n',
        '            try:\n',
        '                el = page.locator(d_sel).last\n',
        '                if el.is_visible():\n',
        '                    dialog = el\n',
        '                    log(f"   📦 Tìm thấy dialog: {d_sel}")\n',
        '                    break\n',
        '            except:\n',
        '                pass\n',
        '\n',
        '        # Bước 2: Click nút Đăng trong dialog (ưu tiên), fallback toàn trang\n',
        '        btn_sels = [\n',
        ...
        '            \'[aria-label="Post"]\',\n',
        '        ]\n',
        '        # Thử trong dialog trước\n',
        '        if dialog and not posted:\n',
        '            for sel in btn_sels:\n',
        '                try:\n',
        ...
        '                    posted = True\n',
        '                    log(f"   🚀 Click Đăng trong dialog: {sel}")\n',
        '                    break\n',
        '                except:\n',
        '                    pass\n',
        '\n',
        '        # Fallback: tìm toàn trang nhưng dùng .last (nút cuối = nút trong dialog)\n',
        '        if not posted:\n',
        '            for sel in btn_sels:\n',
        '                try:\n',
