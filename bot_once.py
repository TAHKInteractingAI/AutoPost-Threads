...
def _write_pw_worker():
    ...
    lines = [
        ...
        '        # Threads render nút Đăng ở footer ngoài [role="dialog"], nên tìm toàn trang\n',
        '        posted = False\n',
        '\n',
        '        btn_sels = [\n',
        ...
        '        ]\n',
        '\n',
        '        # Bước 1: Lấy TẤT CẢ nút matching, lọc visible, click cái cuối cùng\n',
        '        for sel in btn_sels:\n',
        '            if posted:\n',
        '                break\n',
        '            try:\n',
        ...
        '                if not visible_btns:\n',
        '                    continue\n',
        '                # Click nút cuối cùng (nút trong compose dialog, không phải feed)\n',
        '                btn = visible_btns[-1]\n',
        '                btn.scroll_into_view_if_needed()\n',
        '                time.sleep(0.3)\n',
        '                btn.click(force=True)\n',
        '                posted = True\n',
        '                log(f"   🚀 Click Đăng (selector: {sel}, total visible: {len(visible_btns)})")\n',
        '            except Exception as e:\n',
        '                log(f"   ⚠️ Thử {sel}: {e}")\n',
        '\n',
        '        # Bước 2: Fallback dùng JavaScript - tìm button theo text content\n',
        '        if not posted:\n',
        '            log("   🔄 Thử JavaScript click fallback...")\n',
        '            try:\n',
        ...
        '                            return (txt === "Đăng" || txt === "Post") && b.offsetParent !== null;\n',
        '                        });\n',
        ...
        '                else:\n',
        '                    log("   ❌ JS: Không tìm thấy button nào")\n',
        '            except Exception as e:\n',
        '                log(f"   ❌ JS fallback lỗi: {e}")\n',
        '\n',
        '        if not posted:\n',
